...
Objectives currently cover defeat / tame / currency / talk. Natural extensions: collect-item objectives (once an
item inventory exists), reach-region objectives, prerequisite chains (quest B unlocks after A), and persisting
